        ...
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <div class="bor8 dis-flex p-l-15">
                    <!-- Ensure the form and its children are styled to match your design -->
                    <form action="{{ route('searchproduct') }}" method="get" class="search-form">
                        @csrf
                        <button type="submit" class="search-button size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04">
                            <i class="zmdi zmdi-search"></i>
                        </button>
                        <input class="search-input mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search_product" placeholder="Search">
                    </form>
                </div>    
            </div>
